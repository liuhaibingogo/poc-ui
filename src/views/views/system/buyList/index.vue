  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="${comment}" prop="STATUS">
        <el-select v-model="queryParams.STATUS" placeholder="请选择${comment}" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="buyListList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="assetType" />
      <el-table-column label="${comment}" align="center" prop="productCode" />
      <el-table-column label="${comment}" align="center" prop="MAKER" />
      <el-table-column label="${comment}" align="center" prop="modDatetime" width="180">
        <template #default="scope">
          <span>{{ parseTime(scope.row.modDatetime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="${comment}" align="center" prop="CHECKER" />
      <el-table-column label="${comment}" align="center" prop="chckerDatetime" width="180">
        <template #default="scope">
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="buyListRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="${comment}" prop="assetType">
          <el-input v-model="form.assetType" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="${comment}" prop="productCode">
          <el-input v-model="form.productCode" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="MAKER">
          <el-input v-model="form.MAKER" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="modDatetime">
        ...
        <el-form-item label="${comment}" prop="CHECKER">
          <el-input v-model="form.CHECKER" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="chckerDatetime">
          <el-date-picker clearable
